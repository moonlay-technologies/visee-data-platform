...
args = {
    'owner': 'Moonlay',
    'start_date': datetime(2024, 9, 20, tzinfo=local_tz),
    'retries': 2,
...
# -------------------DAG------------------------
dag = DAG(
    dag_id='visee-historical-demographic',
    default_args=args,
...
dag.doc_md = """
Visee ETL for Historical Demographic
"""
...
# ------------------ETL-------------------
live_to_historical_demographic = PostgresOperator(
    task_id='to_historical_demographic',
    postgres_conn_id='postgres_visee',
    sql='sql/historical-demographic.sql', 
    dag=dag
)

# ---------------------------DAG Flow----------------------------
get_time_filter >> live_to_historical_demographic